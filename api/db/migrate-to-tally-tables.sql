-- Migration: Create Tally-specific database tables
-- Run this SQL against your Neon PostgreSQL database to create the new tables
-- The old used_ships and game_data tables will remain untouched for Keel
...
-- Indexes for tally_used_aircraft
